...
for i, row in runs_exclude_df.iterrows():
    ...
    tmp_run_brik_fn = op.join(sub, ses, '{}_space-MNI152NLin2009cAsym_res-2_desc-preproc_bold-clean'.format(tmp_run), 'Cluster1+Cluster2+Cluster3+Cluster4+Cluster5+Cluster6_bucket-REML_z+tlrc.HEAD')
...
label_bucket_dict = {'Cluster1': 1, 'Cluster2': 4, 'Cluster3': 7, 'Cluster4': 10,'Cluster5': 13, 'Cluster6': 16}
