...
analyses = ['rest-group-Cluster1', 'rest-group-Cluster2', 'rest-group-Cluster3', 'rest-group-Cluster4', 'rest-group-Cluster5', 'rest-group-Cluster6']
...
color_dict = {'rest-group-Cluster1': 'Blues',
...
for analysis in analyses:
    img_fn = glob(op.join(results_dir, 'group-avg', analysis, 'Group_Zscr.p0001.p05.minextent=*.nii.gz'))[0]
    output_file = op.join(results_dir, 'group-avg', analysis, '{0}_{1}.png'.format(analysis, op.basename(img_fn)))
