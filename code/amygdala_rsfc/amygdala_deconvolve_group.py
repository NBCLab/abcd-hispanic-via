...
for i, row in runs_exclude_df.iterrows():
    ...
    tmp_run_brik_fn = op.join(
        ...
        "resAmygdalaR_ConsensusMPM_3--1+resAmygdalaR_ConsensusMPM_3--2+resAmygdalaR_ConsensusMPM_3--3_bucket-REML_z+tlrc.HEAD",
    )
...
label_bucket_dict = {
    "resAmygdalaR_ConsensusMPM_3--1": 1,
    "resAmygdalaR_ConsensusMPM_3--2": 4,
    "resAmygdalaR_ConsensusMPM_3--3": 7,
}
